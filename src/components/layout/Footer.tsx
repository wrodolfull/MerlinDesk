      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-400">
              Streamline your appointment scheduling with our comprehensive solution for SMEs,
              barbershops, beauty clinics, and medical practices.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+15551234567" className="text-gray-400 hover:text-white text-sm">
                  (555) 123-4567
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-gray-400 mr-2" />
                <a href="mailto:info@appointease.com" className="text-gray-400 hover:text-white text-sm">
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          ...
          <div className="mt-4 flex justify-center space-x-6">
            ...
            <Link to="/cookies" className="text-gray-400 hover:text-white text-xs">
              Cookie Policy
            </Link>
          </div>
        </div>

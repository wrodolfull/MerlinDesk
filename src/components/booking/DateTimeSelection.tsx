    ...
    <div className="animate-fade-in">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900">
          Select Date & Time
          {professional && (
            <span className="text-gray-500 text-lg ml-2">with {professional.name}</span>
          )}
        </h2>
      </div>
            ...
            {visibleDates.map((date) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-sm ${isSelected ? 'font-semibold' : ''}`}>{dayNumber}</span>
                </button>
              );
            })}
          </div>

...
router.post('/calendar/webhook', async (req: Request, res: Response): Promise<void> => {
...
router.post('/calendar/setup-webhook', async (req: Request, res: Response): Promise<void> => {
...
router.post('/calendar/sync-from-google', async (req: Request, res: Response): Promise<void> => {
...
async function syncGoogleEventToMerlin(
  oauth2Client: any,
...
function extractEventInfoFromGoogle(event: any, userId: string): any {
  try {
...
async function updateMerlinAppointmentFromGoogle(
  event: any,
